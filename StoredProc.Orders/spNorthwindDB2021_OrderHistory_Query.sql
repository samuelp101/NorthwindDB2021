...
Declare @UserName varchar(25)='' ,@OrderID varchar(10), @CustomerID varchar(5), @CompanyName varchar(25);
...
EXEC dbo.spNorthwindDB2021_OrderHistory_Query @UserName, @FromDate, @ToDate, @OrderID, @CustomerID, @CompanyName, @Country, @SalesRepID, @SalesRep, @Shipper, @OrderBy, @AscDesc

--*/
-- EXEC dbo.OrderHistory_Get @UserName = 'SPHUNG', @SalesRep = 'Ja'
-- EXEC dbo.OrderHistory_Get @UserName = 'SPHUNG', @Shipper = 'Fed'
ALTER PROC dbo.spNorthwindDB2021_OrderHistory_Query
...
/*
DECLARE @FromDate varchar(25) = '2019-01-01', @ToDate varchar(25) = '2019-12-31'
Declare @UserName varchar(25) ,@OrderID int, @CustomerID nchar(5), @CompanyName varchar(25);
Declare @SalesRepID int, @SalesRep varchar(50)='Robert', @Shipper varchar(50)='Fed', @Country varchar(15)
